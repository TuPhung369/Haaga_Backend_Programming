        ...
        return (
          <div className={styles.tabContent}>
            ...
            <div className={styles.demoDescription}>
              ...
              <p>
                Get a comprehensive view of your enterprise operations with our
                intuitive dashboard. Monitor key metrics, track team
                performance, and manage tasks all from one central location.
              </p>
              <Link
                to="/docs/frontend/ui-gallery-viewer"
          ...
          <div className={styles.tabContent}>
            ...
            <div className={styles.demoDescription}>
              ...
              <p>
                ...
                analytics tools. Identify trends, forecast future performance,
                and make data-driven decisions to optimize your business
                operations.
              </p>
              <Link
                to="/docs/frontend/ui-gallery-viewer"
        ...
        return (
          <div className={styles.tabContent}>
            ...
            <div className={styles.demoDescription}>
              ...
              <p>
                Protect your sensitive data with our enterprise-grade security
                features. From multi-factor authentication to end-to-end
                encryption, we ensure your information remains secure at all
                times.
              </p>
              <Link
                to="/docs/frontend/authentication"
                className={styles.demoLink}
              >
